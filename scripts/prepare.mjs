...
function ensureWorldCupWidgetScript(html) {
  if (!html.includes('data-world-cup-live') || html.includes('/assets/js/world-cup-live.js?v=20260626-2338')) return html;
  return html.replace('</body>', '<script src="/assets/js/world-cup-live.js?v=20260626-2338" defer></script></body>');
}
