...
async function updateArticle(lang, slug) {
  ...
  if (!html.includes('/assets/js/world-cup-live.js?v=20260626-2338')) {
    html = html.replace('</body>', '<script src="/assets/js/world-cup-live.js?v=20260626-2338" defer></script>\n</body>');
  }
