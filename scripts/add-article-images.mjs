...
const categories = [
  ...
  { lang: 'en', slug: 'technology', files: ['what-is-chatgpt','what-is-google-gemini','what-is-claude-ai','what-is-an-ai-agent','what-is-a-large-language-model','what-is-prompt-engineering','ai-in-uae-government-services','what-is-quantum-computing'] },
  ...
  { lang: 'en', slug: 'saudi-guides', files: ['absher-portal-guide','open-bank-account-saudi','qiyas-guide','qobool-guide','renting-apartment-riyadh','saudi-bank-account-types','saudi-customs-import-guide','saudi-driving-license','saudi-driving-license-transfer','saudi-family-visit-visa','saudi-gosi-guide','saudi-health-insurance','saudi-iqama-guide','saudi-labor-law-basics','saudi-mobile-plans-guide','saudi-nafath-guide','saudi-sadad-payments','tawakkalna-guide'] },
  ...
  { lang: 'ar', slug: 'technology', files: ['what-is-chatgpt','what-is-google-gemini','what-is-claude-ai','what-is-an-ai-agent','what-is-a-large-language-model','what-is-prompt-engineering','ai-in-uae-government-services','what-is-quantum-computing'] },
  ...
  { lang: 'ar', slug: 'guides', files: ['absher-portal-guide','best-restaurants-riyadh','dewa-setup-guide','du-etisalat-sim-guide','dubai-traffic-fines-guide','emirates-id-guide','open-bank-account-saudi','qiyas-guide','qobool-guide','renting-apartment-dubai','renting-apartment-riyadh','saudi-bank-account-types','saudi-customs-import-guide','saudi-driving-license','saudi-driving-license-transfer','saudi-e-visa-guide','saudi-family-visit-visa','saudi-gosi-guide','saudi-health-insurance','saudi-iqama-guide','saudi-labor-law-basics','saudi-mobile-plans-guide','saudi-nafath-guide','saudi-sadad-payments','tawakkalna-guide','uae-bank-account-types','uae-driving-license-guide','uae-gratuity-calculator-guide','uae-health-insurance-guide','uae-labor-law-basics','uae-residence-visa-types','uae-school-year-guide'] },
...
const palettes = {
  ...
  'saudi-guides': ['#123C69', '#22C55E', '#F59E0B'],
...
const icons = {
  ...
  'saudi-guides': `<path d="M350 190h392c33 0 60 27 60 60v246c0 33-27 60-60 60H350c-33 0-60-27-60-60V250c0-33 27-60 60-60Z" fill="#fff" opacity=".16"/><path d="M378 284h336M378 356h336M378 428h222" stroke="#fff" stroke-width="18" stroke-linecap="round" opacity=".72"/><path d="m734 410 47 47 88-105" fill="none" stroke="#fff" stroke-width="22" stroke-linecap="round" stroke-linejoin="round" opacity=".82"/>`,
