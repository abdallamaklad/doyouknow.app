...
function updateArticleHtml(html, { lang, slug, title }) {
  ...
  const featured = `<img class="featured-image" src="${path}" alt="${escapeHtml(alt)}" width="1200" height="675" loading="eager" fetchpriority="high">`;
  // Handles both the original placeholder <div> and an already-rendered <img>,
  // so re-running repoints existing pages at the text-free artwork.
