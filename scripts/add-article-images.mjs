...
const categories = [
  ...
  { lang: 'en', slug: 'saudi-guides', files: ['absher-portal-guide','open-bank-account-saudi','qiyas-guide','qobool-guide','renting-apartment-riyadh','saudi-driving-license','saudi-family-visit-visa','saudi-gosi-guide','saudi-health-insurance','saudi-iqama-guide','saudi-mobile-plans-guide','saudi-nafath-guide','saudi-sadad-payments'] },
  ...
  { lang: 'ar', slug: 'guides', files: ['absher-portal-guide','best-restaurants-riyadh','dewa-setup-guide','du-etisalat-sim-guide','dubai-traffic-fines-guide','emirates-id-guide','open-bank-account-saudi','qiyas-guide','qobool-guide','renting-apartment-dubai','renting-apartment-riyadh','saudi-driving-license','saudi-e-visa-guide','saudi-family-visit-visa','saudi-health-insurance','saudi-iqama-guide','saudi-mobile-plans-guide','saudi-nafath-guide','saudi-sadad-payments','uae-bank-account-types','uae-driving-license-guide','uae-gratuity-calculator-guide','uae-health-insurance-guide','uae-labor-law-basics','uae-residence-visa-types','uae-school-year-guide'] },
